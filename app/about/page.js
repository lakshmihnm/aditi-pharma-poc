...
export default function About() {
  return (
    <div style={{ width: '100%', maxWidth: '1400px', margin: "40px auto", padding: 32, background: "#f5f5f5", borderRadius: 16, boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
      <h1 style={{ textAlign: "center", marginBottom: 24, fontSize: "2rem", color: "#1976d2" }}>About Us</h1>
      <div style={{ marginBottom: 32, textAlign: "center" }}>
        <iframe
          title="C V Raman Nagar Map"
          src="https://www.google.com/maps?q=C+V+Raman+Nagar,+Bengaluru,+Karnataka+560093&output=embed"
          width="100%"
          height="500"
